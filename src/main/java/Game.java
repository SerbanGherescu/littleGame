...
//        Here I told to the user the rules of the game
        JOptionPane.showMessageDialog(null, "RULES : You need to pick a number between 1 and 6 " +
                "\nIf you get high number than me, you win 10 points, otherwise you lose 5 points. " +
                "\nHave fun!");
...
//            Here I initialize the random number
            int x = computerNumber.nextInt(6) + 1;
